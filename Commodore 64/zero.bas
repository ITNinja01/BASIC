10 rem - number guessing game is based on guess and hi-lo
...
200 print
210 next count
220 print:print "you have used all of your guesses."
230 print "the number was";num
240 goto 270
250 print "you got it in";count;
260 print " guesses."
270 print
280 input "play again (y or n) "; a$
